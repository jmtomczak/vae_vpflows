...
def experiment_vae(args, train_loader, val_loader, test_loader, model, optimizer, dir, model_name='vae'):
    ...
    elif model_name == 'vae_HF' or model_name == 'vae_ccLinIAF':
        from utils.training import train_vae_VPflow as train
        from utils.evaluation import evaluate_vae_VPflow as evaluate
    else:
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        model, train_loss_epoch, train_re_epoch, train_kl_epoch = train(epoch, args, train_loader, model, optimizer)
    ...
    # SAVING model (just in case if something wrong with final evaluation)
